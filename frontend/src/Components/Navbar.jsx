  ...
  return (
    <div className='flex justify-between items-center border border-black w-full px-10'>
      ...
      {/* <section className='flex justify-center items-center gap-4'>
        <button className="text-center font-medium border-blue-400 text-blue-400 cursor-pointer hover:bg-blue-400 hover:text-white outline-none border-2 self-center w-20 p-2 rounded-md">Login</button>
        <button className="text-center font-medium border-blue-400 text-blue-400 cursor-pointer hover:bg-blue-400 hover:text-white outline-none border-2 self-center w-20 p-2 rounded-md">Signup</button>
      </section> */}
